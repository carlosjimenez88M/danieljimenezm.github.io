...
#base.url <- /Users/danieljimenez/Desktop/danieljimenezm.github.io/"
...
ruta_in <- "/Users/danieljimenez/Desktop/danieljimenezm.github.io"  #- has de poner la ruta donde tengas el "repo" local
setwd(ruta_in)
