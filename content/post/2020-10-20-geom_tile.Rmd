...
En la `gramática de los gráficos` de  Leland Wilkinson, diseña las reglas básicas y fundamentales para que a la hora de hacer uno, donde su output pueda tener interpretación. Veamos un ejemplo y contextualicemos sobre ello.
...
Este gráfico indica que a medida que 
